...
Write-Output "Gathering data For Quincy Washington..."


Write-OutPut "Hourly Tempearture"
$URI_HourlyT = "https://graphical.weather.gov/xml/sample_products/browser_interface/ndfdXMLclient.php?whichClient=NDFDgen&zipCodeList=98848&begin=" + $TodaysDate + "&end=" + $ThreeDaysFromToday + "&Unit=e&temp=temp&Submit=Submit"
...
$URI_DewPointT = "https://graphical.weather.gov/xml/sample_products/browser_interface/ndfdXMLclient.php?whichClient=NDFDgen&zipCodeList=98848&begin=" + $TodaysDate + "&end=" + $ThreeDaysFromToday + "&Unit=e&dew=dew&Submit=Submit"
...
$URI_RelH = "https://graphical.weather.gov/xml/sample_products/browser_interface/ndfdXMLclient.php?whichClient=NDFDgen&zipCodeList=98848&begin=" + $TodaysDate + "&end=" + $ThreeDaysFromToday + "&Unit=e&rh=rh&Submit=Submit"
...
foreach ($index in 0..$HourlyT_Values.GetUpperBound(0))
    ...
    Write-host "Data saved to C:\Users\weather\QuincyWeatherData.csv"
   
    $Text > C:\Users\weather\QuincyWeatherData.csv
